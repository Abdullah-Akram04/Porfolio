...
export const SkillsInfo = [
  ...
  export const projects = [
    ...
    },
    {
      ...
      title: "",
      description:
        "An educational platform where users can tech and coding-related blogs, notes, interview questions, e-books, and premium content with payment integration. Built with full-stack technologies for a seamless learning experience.",
      image: cmLogo,
