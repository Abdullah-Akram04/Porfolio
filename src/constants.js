...
export const SkillsInfo = [
  ...
  export const projects = [
    ...
    },
    {
      ...
      title: "",
      description:
        "An efficient background built with React.js and API integration. Users can upload any image, remove the background, and download the transparent version for further use.",
      image: removebgLogo,
